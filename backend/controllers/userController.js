...
const registerUser = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Welcome to Project Management, confirm your email to get started!',
      text: 'Welcome to the Project Management!',
      html: `<h1>Thank you for registering!</h1></br><p>To finish registration just click this link</p><span><a href='${process.env.WEBSITE_URL}/confirm/${emailSecretCode}'> ${process.env.WEBSITE_URL}/confirm/${emailSecretCode}</a></span>`,
    };
  ...
  if (user) {
    ...
    try {
      const mailOptions = {
        ...
        to: user.email,
        subject:
          'Welcome to Project Management, confirm your email to get started!',
        text: 'Welcome to the Project Management!',
        html: `<h1>Thank you for registering!</h1></br><p>To finish registration just click this link</p><span><a href='${process.env.WEBSITE_URL}/confirm/${newSecretCode}'> ${process.env.WEBSITE_URL}/confirm/${newSecretCode}</a></span>`,
      };
      await sendEmail(mailOptions);
    } catch (err) {
      console.log(err);
